...
| 🟢 **DOWNLOADED** | **WikiMed Mini (English)** (`wikipedia_en_medicine_mini`) | CC BY-SA 4.0 | ~155 MB. Plain-language first aid and drug information. Downloaded by the MComzOS Ansible playbook from Kiwix's library — not built by this project. |
